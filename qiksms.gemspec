...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A simple way of sending SMS using qiksms}
  spec.description   = %q{This gem is intended for developers that requires SMS integration to their ruby application.}
